...
function pena_lite_customizer_js() {
	wp_enqueue_script('pena-customizer', get_template_directory_uri() . '/js/pena-customizer.js', array(), '1.0.0', true);
	wp_localize_script('pena-customizer', 'pena_lite_links', array(
		'upgradeURL' => esc_url('http://www.anarieldesign.com/themes/pena-charity-wordpress-theme/'),
		'upgradeLabel' => esc_html__('Upgrade to Pena Pro', 'pena-lite'),
		'title'	=> esc_html__('Theme Related Links:', 'pena-lite'),
		'themeURL' => esc_url('http://www.anarieldesign.com/free-charity-wordpress-theme-pena/'),
		'themeLabel' => esc_html__('Theme Info Page', 'pena-lite'),
		'docsURL' => esc_url('http://www.anarieldesign.com/documentation/pena-lite/'),
		'docsLabel'	=> esc_html__('Theme Documentation', 'pena-lite'),
	));
}
add_action('customize_controls_enqueue_scripts', 'pena_lite_customizer_js');